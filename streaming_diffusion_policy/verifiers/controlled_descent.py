...
def _get_lander_centroid(frame: np.ndarray) -> Optional[Tuple[float, float]]:
    """
...
def _get_lander_points(frame: np.ndarray) -> Optional[np.ndarray]:
    """
...
def _estimate_angle(frame: np.ndarray) -> Optional[float]:
    """
